...
// kazushi addition
int trace_zvol_write_return(struct pt_regs *ctx)
{
    char *op = "zvwrite";
    return trace_return(ctx, op);
}

int trace_zvol_read_return(struct pt_regs *ctx)
{
    char *op = "zvread";
    return trace_return(ctx, op);
}

int trace_zvol_close_return(struct pt_regs *ctx)
{
    char *op = "zvclose";
    return trace_return(ctx, op);
}
...
## kazushi addition
b.attach_kprobe(event="zvol_write", fn_name="trace_entry")
b.attach_kprobe(event="zvol_read", fn_name="trace_entry")
b.attach_kprobe(event="zvol_release", fn_name="trace_entry")
...
## kazushi addition
b.attach_kretprobe(event="zvol_write", fn_name="trace_zvol_write_return")
b.attach_kretprobe(event="zvol_read", fn_name="trace_zvol_read_return")
b.attach_kretprobe(event="zvol_release", fn_name="trace_zvol_close_return")
